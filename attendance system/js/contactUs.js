...
window.addEventListener('load', function() {
    ...
    msg = document.getElementById('msg');
      ...
      form.addEventListener('submit', function (event){
        ...
        sendEmail(fname.value, address.value, email.value, msg.value);
        alert("Done");
        // sendTempData(event);
        console.log(fname.value, address.value, email.value, msg.value);
  ...
  function sendEmail(fname, address, email, msg){
    Email.send({
        Host : "smtp.gmail.com",
        ...
        From : `${email}`,
        Subject : `${fname} sent you a message from Contact Us`,
